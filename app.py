...
def seed():
    ...
    categories_data = [
        ...
        ("اسباب بازی، کودک و نوزاد", "fa-baby", "اسباب بازی و کالاهای کودک و نوزاد"),
        ("پزشکی و سلامت", "fa-kit-medical", "تجهیزات پزشکی، سلامت و مراقبت"),
        ("موسیقی و هنر", "fa-music", "آلات موسیقی، هنر و تجهیزات استودیویی"),
        ("صنایع دستی و بومی", "fa-hands", "محصولات محلی، سنتی و صنایع دستی"),
        ("پت شاپ", "fa-paw", "غذا و لوازم حیوانات خانگی"),
        ("مبلمان و دکوراسیون", "fa-couch", "مبلمان، دکور و لوازم خانه"),
        ("طلا و جواهر", "fa-gem", "طلا، جواهر و اکسسوری"),
        ("لوازم سازمانی", "fa-building", "تجهیزات اداری و خرید سازمانی"),
